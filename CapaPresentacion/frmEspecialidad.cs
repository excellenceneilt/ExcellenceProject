...
namespace CapaPresentacion
{
    public partial class frmEspecialidad : Form
    {
        ...
        private void frmEspecialidad_Load(object sender, EventArgs e)
        {
            ...
            {
                dgvdata.Rows.Add(new object[] {"",item.IdEspecialidad,item.Descripcion,
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("¿Desea eliminar la especialidad " + txtdescripcion.Text + "?", "Mensaje", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    string mensaje = string.Empty;
                    Especialidad obj = new Especialidad()
                    {
